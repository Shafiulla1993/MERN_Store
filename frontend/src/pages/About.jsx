    ...
    <div>
      ...
      <div className="flex flex-col gap-16 my-10 md:flex-row">
        ...
        <div className="flex flex-col justify-center gap-6 text-gray-600 md:w-2/4">
          <p>
            Welcome to myStore, where style meets quality. Our mission is to
          ...
          <p>
            At myStore, we prioritize your satisfaction. From the moment you
            ...
            choosing myStore. We’re excited to be a part of your style journey.
          </p>
          <b className="text-gray-800">Our Mission</b>
          <p>
            At myStore, our mission is to empower you to express your unique
          ...
          <p>
            At myStore, our vision is to be a global fashion leader, known for
            cutting-edge style and quality. We aim to inspire confidence and
            creativity, making myStore the go-to choice for individual
            expression.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col mb-20 text-sm md:flex-row">
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          ...
          <p className="text-gray-600">
            At myStore, quality comes first. Every product is carefully chosen
        ...
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          <b>Convenience</b>
          <p className="text-gray-600">
            myStore ensures a smooth shopping experience with easy browsing,
        ...
        <div className="flex flex-col gap-5 px-10 py-8 border md:px-16 sm:py-20">
          ...
          <p className="text-gray-600">
            At myStore, exceptional service is our promise. Our dedicated
